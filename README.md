...
> [!NOTE]
> URLs will stay here for archiving purposes, along with the broken ones. Refer to "[webm](https://github.com/PanIntegralus/discord.webm-compilation/tree/main/webm)" folder on this repository for permanent links.
